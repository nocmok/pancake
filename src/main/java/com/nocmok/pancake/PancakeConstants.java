...
public class PancakeConstants {
    ...
    public static final String KEY_TILED = "pnk_tiled";

    public static final String KEY_BLOCKXSIZE = "pnk_blockxsize";

    public static final String KEY_BLOCKYSIZE = "pnk_blockysize";

    public static final String KEY_PHOTOMETRIC = "pnk_photometric";

    public static final String KEY_BIGTIFF = "pnk_bigtiff";
